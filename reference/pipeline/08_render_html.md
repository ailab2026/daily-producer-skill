...
```bash
# 标准渲染
python3 scripts/render_daily.py output/daily/2026-04-06.json

# 指定输出路径 + 强制渲染
python3 scripts/render_daily.py output/daily/2026-04-06.json --output output/daily/2026-04-06.html --force
```
